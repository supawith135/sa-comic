...
import { GetComicById, GetCategory, GetComic } from "../../services/https";
        ...
        <div className="bg-base-200 h-screen">
          ...
          <div>
            <div className="text-center text-4xl pt-8 text-black">
              ...
              {comic &&  <h1 className="my-10 flex justify-center items-center capitalize text-3xl font-bold">{comic.Title}</h1>}
            </div>
            <div className="">
                {comic && (
                  <>
